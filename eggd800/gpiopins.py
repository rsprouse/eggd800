...
class GpioPins(EggD800HID):
    ...
    LOWMICPREAMP   = 0x00000001  # 00000000000000000000000000000001
    GXSEL          = 0x00000002  # 00000000000000000000000000000010
    FASTAGC        = 0x00000004  # 00000000000000000000000000000100
    NXPRESSURE     = 0x00000008  # 00000000000000000000000000001000
    ACCPREAMP      = 0x00000010  # 00000000000000000000000000010000
    VINSEL         = 0x00000020  # 00000000000000000000000000100000
    I2CPRESSURE    = 0x00000040  # 00000000000000000000000001000000
    P3CONNECTOR    = 0x000FC000  # 00000000000011111100000000000000
    MANOMETRY      = 0x00F00000  # 00000000111100000000000000000000
    AD7689CHANNELS = 0xFF000000  # 11111111000000000000000000000000
